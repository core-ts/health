...
exports.HealthController = exports.check = exports.Status = void 0;
var Status;
(function (Status) {
  Status["UP"] = "UP";
  Status["DOWN"] = "DOWN";
...
function check(services) {
  return __awaiter(this, void 0, void 0, function () {
    var p, total, count, _i, services_1, service, sub, r, err_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          sub = { status: Status.UP };
          _a.label = 2;
        case 2:
          _a.trys.push([2, 4, , 5]);
          return [4, service.check()];
        case 3:
          r = _a.sent();
        ...
        case 4:
          ...
          sub.data = service.build(new Map(), err_1);
          p.details.set(service.name(), sub);
          if (count >= total) {
            return [2, p];
          }
...
var HealthController = (function () {
  function HealthController(healthServices) {
    this.healthServices = healthServices;
    this.check = this.check.bind(this);
  }
  HealthController.prototype.check = function (req, res) {
    check(this.healthServices).then(function (heath) {
